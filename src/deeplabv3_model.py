...
def deeplabv3_resnet50(aux, num_classes=21, pretrain_backbone=False):
    ...
    if pretrain_backbone:
        ...
        backbone.load_state_dict(torch.load("/public/home/zengqiong007/hominid/src/resnet50.pth", map_location='cpu'))
...
def deeplabv3_resnet101(aux, num_classes=21, pretrain_backbone=False):
    ...
    if pretrain_backbone:
        ...
        backbone.load_state_dict(torch.load("/public/home/zengqiong007/hominid/src/resnet101.pth", map_location='cpu'))
...
def deeplabv3_mobilenetv3_large(aux, num_classes=21, pretrain_backbone=False):
    ...
    if pretrain_backbone:
        ...
        backbone.load_state_dict(torch.load("/public/home/zengqiong007/hominid/src/mobilenet_v3_large.pth", map_location='cpu'))
